    ...
    */
    {
        ...
        inGameScoreText.color = new Color(1f, 1f, 1f); // White to highlight
                                                       // that score has not
                                                       // exceeded
    }
        ...
        if (inGameScore > highScore)
        {
            ...
            if (!highScoreExceeded)
            {
                ...
                AudioManager.instance.Play("New High Score"); // Playing high
                                                              // score exceeded
                                                              // music
                inGameScoreText.color = new Color(0f, 0.9082564f, 1f); 
                // Mango yellow to highlight that score has exceeded
            }           
        }
    }
